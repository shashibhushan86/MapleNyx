        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="footer4-text16">Data Analytics</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="footer4-text18">Data Engineering</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="footer4-text19">Murex Consulting</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link5 ?? (
                <Fragment>
                  <span className="footer4-text14">Digital Transformation</span>
                </Fragment>
              )}
            </a>
          </div>
