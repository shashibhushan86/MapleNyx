          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      ...
                      tailor our IT consulting services accordingly.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text27">Customized Solutions</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Our team of experts will design customized solutions in
                      Data Analytics, Data Engineering, AI, Murex Consulting,
                      and more to meet your specific requirements.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      We seamlessly integrate the proposed solutions into your
                      existing systems ensuring a smooth transition and minimal
                      disruption.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text32">Continuous Support</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      ...
                      your IT infrastructure remains optimized and up-to-date.
                    </span>
                  </Fragment>
                )}
              </span>
